# Contribuindo com o Observátorio de Resíduos. 

Caso queira contribuir com o projeto, talvez seja uma boa ideia começar pelo [README](https://github.com/ObservatorioDeResiduos-GCES-2018/2016.2-Observatorio-de-Residuos-Frontend) para conhecer melhor sobre nós.
...
* Se o bug encontrado não consta nas _Issues_, basta abrir uma [Nova _Issue_](https://github.com/ObservatorioDeResiduos-GCES-2018/2016.2-Observatorio-de-Residuos-Frontend/issues/new).


## Adicionando e/ou modificando alguma funcionalidade

* Primeiro verifique que não existe nenhuma [_Issue_](https://github.com/ObservatorioDeResiduos-GCES-2018/2016.2-Observatorio-de-Residuos-Frontend/issues) a respeito dessa modificação e/ou adição.

* Caso não exista, crie uma [Nova _Issue_](https://github.com/ObservatorioDeResiduos-GCES-2018/2016.2-Observatorio-de-Residuos-Frontend/issues/new). Dê um título significativo a ela, coloque uma descrição e pelo menos uma _label_.

* As mudanças devem ser submetidas através de [_Pull Requests_](https://github.com/ObservatorioDeResiduos-GCES-2018/2016.2-Observatorio-de-Residuos-Frontend/issues/new/compare).
